...
using FeatureApplication.Core.Interfaces;
    ...
    public class DatabaseInitializer : IDatabaseInitializer {
        ...
        public async Task SeedAsync () {
            ...
            if (!await _context.Users.AnyAsync ()) {
                ...
                await createUserAsync ("admin", "tempP@ss123", "Inbuilt Administrator", "admin@dhanaifruitsmart.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await createUserAsync ("user", "tempP@ss123", "Inbuilt Standard User", "user@dhanaifruitsmart.com", "+1 (123) 000-0001", new string[] { userRoleName });
